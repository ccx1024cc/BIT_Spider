...
/**   
 * @Title: GJJLHZCNoticeContentExtractor.java 
 * @Package com.bit.ss.extractor 
 * @Description:  国际交流合作处，内容提取器
 * @author CCX
 * @date 2015年11月8日 上午11:17:28 
 * @version V1.0   
 */
public class GJJLHZCNoticeContentExtractor extends ContentExtractor {

	public GJJLHZCNoticeContentExtractor(String url, CloseableHttpClient client) {
		super(url, client);
	}
	...
	public Object extract() throws Exception {
		...
		try {
			...
			Element content = html.select("div.rt_zhengwen").first();
